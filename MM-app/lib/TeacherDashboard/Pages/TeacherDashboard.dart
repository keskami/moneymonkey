...
import 'package:money_monkey/TeacherDashboard/Pages/TeacherCalendar.dart';
...
class _TeacherDashboardState extends State<TeacherDashboard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Obx(() {
        // Check if current page is Calendar to adjust spacing
        bool isCalendarPage = controller.currentPage.value==TeacherCalendar();
        
        // Define spacing based on current page
        double topSpacing = isCalendarPage ? screenHeight * 0.02 : screenHeight * 0.04;
        double headerSpacing = isCalendarPage ? screenHeight * 0.01 : screenHeight * 0.04;
        double subPageSpacing = isCalendarPage ? screenHeight * 0.01 : screenHeight * 0.02;
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    CircleAvatar(
                      radius: isCalendarPage ? 20 : 25, // Smaller avatar for calendar page
                      ...
                      child: Obx(() {
                        ...
                        return profileUrl.isNotEmpty
                            ...
                            : Icon(Icons.person, color: Colors.white, size: isCalendarPage ? 18 : 24);
                      }),
                    ),
                    Obx(() {
