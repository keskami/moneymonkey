...
class _TeacherCalendarState extends State<TeacherCalendar> {
  ...
  List<CalendarEvent> get filteredEvents {
    ...
    String selectedClassName = teacherDashboardController
            .classes[teacherDashboardController.selectedClassId.value] ??
        '';
    return selectedClassName.isEmpty
        ? events
        : events
            .where((event) => event.className == selectedClassName)
            .toList();
  }
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _buildEventSummaryCard(
                            'Activities',
                            filteredEvents
                                .where((e) => e.type == EventType.activity)
                                .length,
                      ...
                      Expanded(
                        child: _buildEventSummaryCard(
                            'Meetings',
                            filteredEvents
                                .where((e) => e.type == EventType.meeting)
                                .length,
                            Colors.purple),
                      ),
                      const SizedBox(width: 16),
                      Expanded(
                        child: _buildEventSummaryCard(
                            'Reminders',
                            filteredEvents
                                .where((e) => e.type == EventType.reminder)
                                .length,
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  value: selectedEvent!.className.isEmpty
                      ? null
                      : selectedEvent!.className,
                  items: [
                    ...teacherDashboardController.classes.values
                  ...
                  onChanged: (value) {
                    if (value != null) {
                      String classId =
                          teacherDashboardController.getClassId(value);
                      setState(() {
                ...
                TextField(
                  ...
                  controller:
                      TextEditingController(text: selectedEvent!.description),
                  maxLines: 3,
                  onChanged: (value) {
                    setState(() {
                      selectedEvent =
                          selectedEvent!.copyWith(description: value);
                    });
                  },
                ),
                const SizedBox(height: 16),
                  ...
                  children: [
                      ...
                      child: TextButton.icon(
                        onPressed: () {
                          _selectDate(context, selectedEvent!.date, (date) {
                            setState(() {
                              selectedEvent =
                                  selectedEvent!.copyWith(date: date);
                            });
                          });
                        },
                    ...
                    if (selectedEvent!.type == EventType.assignment)
                      Expanded(
                        child: TextButton.icon(
                          onPressed: () {
                            _selectDate(context, selectedEvent!.dueDate,
                                (date) {
                              setState(() {
                                selectedEvent =
                                    selectedEvent!.copyWith(dueDate: date);
                              });
                            });
                          },
                              ...
                              ElevatedButton(
                                onPressed: () {
                                  ...
                                  if (url.isNotEmpty) {
                                    setState(() {
                                      selectedEvent =
                                          selectedEvent!.addAttachment(url);
                                    });
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: selectedEvent!.title.isNotEmpty &&
                    selectedEvent!.className.isNotEmpty
                ? () {
                    Navigator.of(context).pop();
                    handleSaveEvent();
                  }
