                ...
                : Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // (Keep the existing mobile implementation for now)
                        Center(child: Text("Mobile view - ${userData!.name}")),
                      ],
                    ),
                  ),
          ),
