...
extension SubComponentTypeExtension on SubComponentType {
  String get name => toString().split('.').last;

  static SubComponentType fromString(String name) {
    return SubComponentType.values.firstWhere(
...
class SubComponent {
  ...
  factory SubComponent.fromMap(Map<String, dynamic> map) {
    ...
    final type = SubComponentTypeExtension.fromString(typeStr);
