...
//   /// Update a single component's status (local only for now)
//   Future<void> updateComponentStatus(
//       String componentId, Status newStatus) async {
//     try {
//       // Update local instance only
//       if (_components.containsKey(componentId)) {
//         _components[componentId] = Component(
//           componentId: _components[componentId]!.componentId,
//           title: _components[componentId]!.title,
//           type: _components[componentId]!.type,
//           componentStatus: newStatus,
//           questionData: _components[componentId]!.questionData,
//           performanceTrends: _components[componentId]!.performanceTrends,
//           discussionQuestions: _components[componentId]!.discussionQuestions,
//           progress: _components[componentId]!.progress,
//         );
//       } else {
//         throw Exception('Component not found: $componentId');
//       }

//       print('Component status updated locally: $componentId -> ${statusToFirestore(newStatus)}');
      
//       // Simulate network delay for testing UI responsiveness
...
//   /// Update multiple component statuses (local only for now)
//   Future<void> updateMultipleComponentStatuses(
//       Map<String, Status> updates) async {
//     try {
//       // Update local instances only
//       updates.forEach((componentId, newStatus) {
//         if (_components.containsKey(componentId)) {
//           _components[componentId] = Component(
//             componentId: _components[componentId]!.componentId,
//             title: _components[componentId]!.title,
...
//           );
//         } else {
//           print('Component not found (skipping): $componentId');
//         }
//       });
      
//       print('Updated ${updates.length} component statuses locally');
...
//       throw Exception('Failed to update component statuses: $e');
//     }
//   }
// }
...
//     try {
//       final docSnapshot =
//           await _firestore.collection('teachers').doc(_teacher.id).get();
...
//     if (!_isInitialized) {
//       throw Exception(
//           'CachedDataService not initialized. Call initialize() first.');
//     }
//   }
...
//   /// Update component status in Firestore and local cache
//   // Add these methods to your LocalAcademicService class

//   /// Update a single component's status in Firebase
//   Future<void> updateComponentStatus(
//       String componentId, Status newStatus) async {
//     final connectivity = await Connectivity().checkConnectivity();
//     if (connectivity == ConnectivityResult.none) {
//       throw Exception('Cannot update component status while offline');
//     }
...
//   /// Update multiple component statuses in a single batch
//   Future<void> updateMultipleComponentStatuses(
//       Map<String, Status> updates) async {
//     final connectivity = await Connectivity().checkConnectivity();
//     if (connectivity == ConnectivityResult.none) {
//       throw Exception('Cannot update component statuses while offline');
//     }
...
//       // Add each component update to the batch
//       updates.forEach((componentId, newStatus) {
//         final docRef = FirebaseFirestore.instance
//             .collection('components')
//             .doc(componentId);
//         batch.update(docRef, {'ComponentStatus': statusToFirestore(newStatus)});
//       });
...
//         _dataManager.getClassroom(classRoomId), classRoomId, 'Classroom');
//   }

//   // Get a unit by ID
//   Unit getUnit(String unitId) {
//     return _getEntityById(_dataManager.getUnit(unitId), unitId, 'Unit');
//   }

//   // Get a lesson by ID
//   Lesson getLesson(String lessonId) {
//     return _getEntityById(_dataManager.getLesson(lessonId), lessonId, 'Lesson');
//   }

//   // Get a component by ID
//   Component getComponent(String componentId) {
//     return _getEntityById(
//         _dataManager.getComponent(componentId), componentId, 'Component');
//   }

//   // Get all classrooms (compatible with your existing API)
//   Map<String, String> getAllClassrooms() {
//     final classrooms =
//         _dataManager.getClassroomsForTeacher('temporaryTeacherId2025');
