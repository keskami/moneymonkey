...
class _MeterBoxState extends State<MeterBox> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      height: widget.screenHeightUnit * 230,
      ...
      child: Column(
        ...
        children: [
          Padding(
            padding: EdgeInsets.fromLTRB(widget.screenWidthUnit * 24,
          ...
          Row(
            ...
            children: [
                ...
                children: [
                  Padding(
                      padding: EdgeInsets.fromLTRB(
                          widget.screenWidthUnit * 25, widget.screenHeightUnit * 15, 0, 0),
                      child: Row(
                        children: [
                          Text('${widget.creditScore}',
                              style: GoogleFonts.baloo2(
                                fontSize: widget.screenWidthUnit * 55,
                                fontWeight: FontWeight.w600,
                          ...
                          Padding(
                            padding: EdgeInsets.only(
                              top: widget.screenHeightUnit * 30,
                            ),
                            child: Text(
                              '/850',
                              style: GoogleFonts.baloo2(
              ...
              Padding(
                ...
                child: Container(
                  height: widget.screenHeightUnit * 107,
