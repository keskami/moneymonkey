        ...
        : BudgetSimulator(
            ...
            expenses: [
              Expense(
                  ...
                  dueDay: DateTime(2025, 5, 1),
                  amountPaid: 0,
                  penalty: 0, amountToStartMonth: 0),
              Expense(
                  name: "Pay Day",
                  amount: -2100,
                  dueDateType: "Fixed",
              ...
              Expense(
                  ...
                  dueDay: DateTime(2025, 5, 3),
                  amountPaid: 20,
                  penalty: 25,  amountToStartMonth: 1200),
              Expense(
                  name: "Utilities",
                  amount: 150,
                  dueDateType: "Fixed",
                  dueDay: DateTime(2025, 5, 5),
                  amountPaid: 0,
                  penalty: 25, amountToStartMonth: 150),
              Expense(
                  name: "Internet & Phone",
                  amount: 100,
                  dueDateType: "Fixed",
                  dueDay: DateTime(2025, 5, 8),
                  amountPaid: 0,
                  penalty: 25, amountToStartMonth: 100),
              Expense(
                  name: "Transportation",
                  amount: 100,
                  dueDateType: "Fixed",
                  dueDay: DateTime(2025, 5, 10),
                  amountPaid: 10,
                  penalty: 10, amountToStartMonth: 100),
              Expense(
                  name: "Subscriptions & Memberships",
                  amount: 50,
                  dueDateType: "Fixed",
                  dueDay: DateTime(2025, 5, 20),
                  amountPaid: 0,
                  penalty: 10, amountToStartMonth: 50),
              Expense(
                  name: "CC Debt",
                  amount: 300,
                  dueDateType: "Fixed",
                  dueDay: DateTime(2025, 5, 25),
                  amountPaid: 0,
                  penalty: 50, amountToStartMonth: 300),
              Expense(
                  name: "Groceries",
                  amount: 300,
                  dueDateType: "Fixed",
                  dueDay: DateTime(2028, 5, 15),
                  amountPaid: 0,
                  penalty: 0, amountToStartMonth: 300),
              Expense(
                  name: "Fitness",
                  amount: 0,
                  dueDateType: "Fixed",
