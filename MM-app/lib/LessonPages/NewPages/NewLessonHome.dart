...
import 'package:money_monkey/LessonPages/NewPages/NewLessonHomeUnit.dart';
...
class NewLessonsHome extends StatefulWidget {
   NewLessonsHome({Key? key}) : super(key: key);

  @override
  State<NewLessonsHome> createState() => _NewLessonsHomeState();
}

class _NewLessonsHomeState extends State<NewLessonsHome> {
