  ...
  try {
    ...
    final conceptPages = {
      'conceptPage_1': {
        ...
        'correct': "That's right! Financial responsibility can start early, from\nyour first paycheck or allowance. Let's explore why.",
        'wrong': "Coins have been used since\naround 600 B.C., making them the\noldest form of money still in use.",
      },
      'conceptPage_2': {
        'title': "Definition: Financial Responsibility Over a Lifetime",
        'definitionHeader': "Definition:",
        'definition': "Financial responsibility over a lifetime means consistently making informed decisions about earning, saving, spending, and investing, starting from your earliest income and continuing through retirement.",
        'whyItMatters': "Why does it matter? Because small habits formed early—like setting aside a little money or comparing prices—can grow into long-term financial stability.",
      },
      'conceptPage_3': {
        "title": "Definition: Financial Responsibility Over a Lifetime",
        "iconLinks": [
      ...
      'conceptPage_4': {
        ...
        'subTitle': 'Jordan is on a journey from high school to retirement. Let\'s help them make smart financial choices!',
        'options': ["Save 10%", "Spend all of it"],
        'correct': "Great habit! Even \$5 a week adds up over time.",
        'wrong': "Coins have been used since\naround 600 B.C., making them the\noldest form of money still in use.",
        'containerHeading': "High School",
        'containerSubHeading': "Jordan earns \$50/week from chores. Should Jordan save 10% (\$5) or spend it all?",
      ...
      'conceptPage_5': {
        ...
        'correct': "Smart move! This helps Jordan track\nspending and allocate money for bills,\nsavings, and fun.",
        'wrong': "Coins have been used since\naround 600 B.C., making them the\noldest form of money still in use.",
        'containerHeading': "High School",
        'containerSubHeading': "Jordan just started a full-time job. Should he create a monthly budget first or just wing it?",
      ...
      'conceptPage_6': {
        ...
        'correct': "Yes! Unexpected costs like medical\nbills or childcare can pop up. Having a\ncushion is crucial.",
        'wrong': "Coins have been used since\naround 600 B.C., making them the\noldest form of money still in use.",
        'containerHeading': "Family Planning",
        'containerSubHeading': "Jordan is thinking about starting a family soon. How important is it to have an emergency fund?",
      ...
      'conceptPage_7': {
        ...
        'subTitle': "Jordan is on a journey from high school to retirement. Let's help them make smart financial choices!",
        'options': ["Yes", "No"],
        'correct': "Yes! Consistent budgeting helps\nensure savings last throughout\nretirement.",
        'wrong': "Coins have been used since\naround 600 B.C., making them the\noldest form of money still in use.",
        'containerHeading': "Retirement",
        'containerSubHeading': "Jordan is now approaching retirement. Should they continue some form of budgeting?",
        'correctAnswer': "Yes",
      },
      'conceptPage_8': {
        ...
        "correctAnswer1": "Saving and investing a portion of earnings regularly",
        "correctAnswer2": "It covers unexpected expenses, reducing stress and debt",
        "2Correct": "Yes, both these answers are correct!",
        "1Correct": "Only one of these answers are\ncorrect!",
        "0Correct": "Recheck your answer please.",
        "question1": "Which of the following best describes a strong financial habit at any age?",
        "question2": "Which is a key benefit of having an emergency fund?",
      },
      'conceptPage_9': {
        "title": "Key Takeaways: Lifelong Financial Responsibility",
        "reflectionHeader": "Personal Reflection",
        ...
        "image": "https://firebasestorage.googleapis.com/v0/b/money-monkey-f4d73.appspot.com/o/Images%20and%20Vectors%2FLessonPages%2Ftakeaway_check.png?alt=media&token=9a389932-5562-4c38-a970-9ecd6bf8adcb",
      },
    };
    ...
    final concept2Pages = Map<String, dynamic>.from(conceptPages);
    
    // Modify specific fields for Concept2
    concept2Pages['concept2Page_2']['title'] = "Definition Recap";
    concept2Pages['concept2Page_2']['definitionHeader'] = "Definition Recap";
    ...
    await storyRef.set({
      ...
      'storyPage_2': {
        ...
        'introduction': "Meet Minty the Money Monkey"
      },
      'storyPage_3': {
        'largeTitle': "Financial Responsibility Story",
        'subtitle': "Taking control of your money to build a secure future",
        'title': "Alex earns \$4,000 monthly but often runs out of money by month-end.",
    ...
    await scenarioRef.set({
      'scenarioPage_1': {
        'title': "Congratulations! You've just started your first part-time job and earned your first paycheck of \$500. You have several things you want to do with the money: buy new sneakers, save for college, and plan for weekend activities.",
    ...
    await peerReflectionRef.set({
      ...
      'peerReflectionPage_4': {
        "title": "Reflection",
        "subTitle": "Which peer's financial situation do you relate to most? Why?",
    ...
    await quizRef.set({
      ...
      'quizPage_3': {
        "question": "Which of the following are good financial\nstrategies? (select all that apply)",
      ...
      'quizPage_4': {
        "question": "What actions demonstrate financial\nresponsibility? (select all that apply)",
      ...
      'quizPage_5': {
        ...
        "options": ["Saving for Retirement", "Planning for college tuition", "Saving for a concert ticket"],
...
// Helper function to get page info from Firestore
...
void main() async {
  await addLessonToFirestore(
    ...
    unitNumber: 1,
    unitDescription: "Learn how to create a budget and manage expenses.",
