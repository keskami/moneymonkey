...
import styles from './InvestingSimulator.module.css';
...
const InvestingSimulatorPage = () => {
  return (
    <div className={styles.comingSoonContainer}>
      {/* Title */}
      <div className={styles.titleSection}>
        <h1>Investing Simulator</h1>
      </div>
      ...
      <div className={styles.mainSection}>
        ...
        <div className={styles.simulatorPreview}>
          <Image
            src="/simulator-images/investing.png" // Add your actual image path
            alt="Investing Simulator Preview"
            fill
            priority
...
export default InvestingSimulatorPage;