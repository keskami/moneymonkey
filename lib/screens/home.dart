...
bool _isLessonEnabled(int itemIndex, int sectionIndex) {
  ...
  bool previousSectionLastLessonCompleted =
      progressController.currentLessonIndex.value >= (sectionIndex * itemsPerSection - 1);
  ...
  return progressController.currentLessonIndex.value >= (startLessonIndexForSection + itemIndex - 1);
}
