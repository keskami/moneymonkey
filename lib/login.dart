...
Future<void> createUserWithProfile({
    ...
    try {
      ...
      // Set the user document with the provided user data
      await userDoc.set(userData, SetOptions(merge: true));  // Using merge to avoid overwriting other fields
  ...
  Future<void> createNewUser() async {
    try {
      ...
      Map<String, dynamic> userData = {
        "Email": _createEmailController.text,
        "Age": 0,
        "Knowledge Level": "Test Level",
        "Learning Goal Per Day": "Test Goal",
        "Starting Level": "Test Level",
      };

      // Profile data to be stored within the user document
      Map<String, dynamic> profileData = {
        "Full Name": "Test Name",
        "Username": "Test123",
        "Number of Followers": 0,
        "Following": 0,
        "Top Achievements": ["Test 1", "Test 2"],
        "Streak": 0,
        "Total Profit": 0.00,
        "Portfolio Score": 0.0,
        "Average Monthly Growth": 0.0,
      };

      // Create user and profile data in Firestore
      await createUserWithProfile(userId: userId, userData: userData, profileData: profileData);
  ...
  if (e.code == 'weak-password') {
    ...
    print('Invalid API key. Check your Firebase configuration.');
  }
} catch (e) {
  print(e);
}
